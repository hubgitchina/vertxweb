...
public class JsonUtils {
	...
	public static ObjectMapper createDefaultJsonMapper(@Nullable PropertyNamingStrategy strategy) {
		...
		// mapper.serializerByType(Long.class,
		...
		// 长整数 序列化为String
		simpleModule.addSerializer(Long.class, ToStringSerializer.instance).addSerializer(Long.TYPE,
	 ...
	 * @param type
	 *            object type must not be null
	 * @param <T>
	 *            target object type
	 * @return object specified type
	 * @throws IOException
	 *             throws when fail to convert
	 */
	@NotNull
	public static <T> T jsonToObject(@NotNull String json, @NotNull Class<T> type)
			throws IOException {
	 ...
	 */
	@NotNull
	public static String objectToJson(@NotNull Object source, @NotNull ObjectMapper objectMapper)
			throws JsonProcessingException {
	 ...
	 */
	@NotNull
	public static <T> T mapToObject(@NotNull Map<String, ?> sourceMap, @NotNull Class<T> type)
			throws IOException {
	 ...
	 */
	@NotNull
	public static Map<?, ?> objectToMap(@NotNull Object source, @NotNull ObjectMapper objectMapper)
			throws IOException {
