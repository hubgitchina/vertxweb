    ...
    <div class="layui-layout layui-layout-admin">
            ...
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu"
                    ...
                    <li data-name="component" class="layui-nav-item">
                        <a href="javascript:;" lay-tips="菜谱管理" lay-direction="2">
                        ...
                        <dl class="layui-nav-child">
                            ...
                            <dd data-name="progress">
                                <a lay-href="component/progress/index.html">菜谱仓库</a>
                            </dd>
                            <dd data-name="nav">
                                <a lay-href="component/nav/index.html">历史菜谱</a>
                            </dd>
                            <dd data-name="panel">
                                <a lay-href="component/panel/index.html">数据分析</a>
                            </dd>
                        </dl>
                    </li>
                </ul>
        ...
        <div class="layui-body" id="LAY_app_body">
            <div class="layadmin-tabsbody-item layui-show">
                <iframe src="freeMarker/list" frameborder="0" class="layadmin-iframe"></iframe>
            </div>
        </div>
