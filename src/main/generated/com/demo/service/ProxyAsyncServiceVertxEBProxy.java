...
public class ProxyAsyncServiceVertxEBProxy implements ProxyAsyncService {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public ProxyAsyncServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public ProxyAsyncServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public  void queryTag(Handler<AsyncResult<JsonArray>> resultHandler){
    ...
    _deliveryOptions.addHeader("action", "queryTag");
